		...
		<>
			<div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 h-screen">
	            <div className="mr-auto place-self-center lg:col-span-7 ">
	                <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">Lucian Web Services</h1>
		...
		<>
			<div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 lg:h-screen sm:h-auto">
		      <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
		          ...
		          <p className="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Empower your client's experience with our services available at accesible prices</p>
		      </div>
